                        ...
                        <form id="searchform" action="post_step1.php" method="post" onsubmit="return check();">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>合同编号</td>
                                        <td><span><?=$infoArr['CONTRACT_NUMBER'] ?></span></td>
                                        <td>合同签订日期</td>
                                        <td><span><?=date('Y-m-d H:i:s',$infoArr['CONTRACT_TIME']) ?></span></td>
                                        <td>合同金额</td>
                                        <td><span><?=$infoArr['CONTRACT_AMOUNT'] ?></span></td>
                                        <td>申请日期</td>
                                        <td><span><?=date('Y-m-d H:i:s',$infoArr['APPLY_TIME']) ?></span></td>
                                    </tr>
                                    <tr>
                                        <td>合同及洽商金额</td>
                                        <td colspan="3"><span><?=$infoArr['CONTRACT_TALK_AMOUNT'] ?></span></td>
                                    <td>洽商金额</td>
                                    <td><span><?=$infoArr['TALK_AMOUNT'] ?></span></td>
                                    <td>洽商内容</td>
                                    <td><span><?=$infoArr['TALK'] ?></span></td>
                                </tr>
                                
                                <tr>
                                    <td>甲方名称</td>
                                    <td colspan="3"><span><?=$infoArr['PARTY_A_NAME'] ?></span></td>
                                    <td>项目经理及电话</td>
                                    <td><?=$infoArr['PROJECT_MANAGER'] ?></span></td>
                                    <td>紧急联系人及电话</td>
                                    <td><span><?=$infoArr['EMERGENCY_MOBILE'] ?></span></td>
                                </tr>
                                <tr>
                                    <td>工程名称</td>
                                    <td colspan="3"><span><?=$infoArr['PROJECT_NAME'] ?></span></td>
                                    <td>开工日期</td>
                                    <td><span><?php if($infoArr['BEGIN_TIME']){echo date('Y-m-d H:i:s',$infoArr['BEGIN_TIME']);} ?></span></td>
                                    <td>竣工日期</td>
                                    <td><span><?php if($infoArr['END_TIME']){echo date('Y-m-d H:i:s',$infoArr['END_TIME']);} ?></span></td>
                                </tr>
                                <tr>
                                    <td>本项目应收账款</td>
                                    <td colspan="3"><span><?=$project_take_amount ?></span></td>
                                    <td>开票回款累计</td>
                                    <td colspan="3"><span><?=$project_back_sum ?></span></td>
                                </tr>
                                <tr>
                                    <td>本次开票金额</td>
                                    ...
                                    <td colspan="2">累计开票金额<input type="hidden" id="note_amount_hidden" <?php if($dataArr){ ?> value="<?=$dataArr['NOTE_AMOUNT_SUM'] ?>" <?php }?>></td>
                                    <td colspan="2"><input type="text" name="NOTE_AMOUNT_SUM" id="note_amount_sum" disabled <?php if($dataArr){ ?> value="<?=$dataArr['NOTE_AMOUNT_SUM'] ?>" <?php }?>></td>
